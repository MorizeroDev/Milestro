...
MILESTRO_API int64_t MilestroUnityRenderCreateVulkanTarget([[milize::CSharpType("IntPtr")]] void* nativeTexture,
                                                           int32_t width,
                                                           int32_t height,
...
MILESTRO_API int64_t
MilestroGameModelDataEnvelopDestroy([[milize::RefType("ref")]] milestro::game::model::DataEnvelop*& ret);
...
MILESTRO_API int64_t MilestroGameModelBytesWrapperCStr(milestro::game::model::BytesWrapper* ret,
                                                       ...
                                                       uint64_t& size);
MILESTRO_API int64_t MilestroGameModelNumberWrapperCreate(milestro::game::model::NumberWrapper*& ret, double number);
MILESTRO_API int64_t MilestroGameModelNumberWrapperValue(milestro::game::model::NumberWrapper* ret, double& value);
...
MILESTRO_API int64_t MilestroSkiaFontRegistryResolveTypefaceFromFamilies(
        ...
        float size,
        int32_t fallbackToSystem);
MILESTRO_API int64_t MilestroSkiaFontRegistryResolveTypefaceFromFamilyTokens(
        milestro::skia::Font*& ret,
        [[milize::CSharpType("void**")]] uint8_t** families,
        ...
        float size,
        int32_t fallbackToSystem);
MILESTRO_API int64_t MilestroSkiaFontRegistryResetFontFamilyKeywordMappings();
MILESTRO_API int64_t MilestroSkiaFontRegistrySetFontFamilyKeywordMapping(
        [[milize::CSharpType("byte*")]] uint8_t* keyword,
...
MILESTRO_API int64_t
MilestroSkiaFontFamilyListDestroy([[milize::RefType("ref")]] milestro::skia::MilestroFontFamilyList*& ret);
MILESTRO_API int64_t MilestroSkiaFontFamilyListGetSize(milestro::skia::MilestroFontFamilyList* list, uint64_t& size);
...
MILESTRO_API int64_t MilestroSkiaFontFamilyListGetElementAt(milestro::skia::MilestroFontFamilyList* list,
                                                            ...
                                                            uint64_t index);
MILESTRO_API int64_t
MilestroSkiaFontFamilyInfoDestroy([[milize::RefType("ref")]] milestro::skia::MilestroFontFamilyInfo*& ret);
...
MILESTRO_API int64_t
MilestroSkiaFontFaceListDestroy([[milize::RefType("ref")]] milestro::skia::MilestroFontFaceList*& ret);
MILESTRO_API int64_t MilestroSkiaFontFaceListGetSize(milestro::skia::MilestroFontFaceList* list, uint64_t& size);
...
MILESTRO_API int64_t MilestroSkiaFontFaceListGetElementAt(milestro::skia::MilestroFontFaceList* list,
                                                          ...
                                                          uint64_t index);
MILESTRO_API int64_t
MilestroSkiaFontFaceInfoDestroy([[milize::RefType("ref")]] milestro::skia::MilestroFontFaceInfo*& ret);
...
MILESTRO_API int64_t MilestroSkiaFontFaceInfoGetFamilyName(milestro::skia::MilestroFontFaceInfo* ret,
                                                           [[milize::CSharpType("IntPtr")]] uint8_t*& ptr,
                                                           uint64_t& size);
MILESTRO_API int64_t MilestroSkiaFontFaceInfoGetFaceIndex(milestro::skia::MilestroFontFaceInfo* ret, int32_t& value);
MILESTRO_API int64_t MilestroSkiaFontFaceInfoGetInstanceIndex(milestro::skia::MilestroFontFaceInfo* ret,
                                                              int32_t& value);
MILESTRO_API int64_t MilestroSkiaFontFaceInfoGetPackedIndex(milestro::skia::MilestroFontFaceInfo* ret, int32_t& value);
MILESTRO_API int64_t MilestroSkiaFontFaceInfoGetWeight(milestro::skia::MilestroFontFaceInfo* ret, int32_t& value);
MILESTRO_API int64_t MilestroSkiaFontFaceInfoGetWidth(milestro::skia::MilestroFontFaceInfo* ret, int32_t& value);
MILESTRO_API int64_t MilestroSkiaFontFaceInfoGetSlant(milestro::skia::MilestroFontFaceInfo* ret, int32_t& value);
MILESTRO_API int64_t MilestroSkiaFontFaceInfoGetFixedPitch(milestro::skia::MilestroFontFaceInfo* ret, int32_t& value);

MILESTRO_API int64_t MilestroSkiaTypefaceDestroy([[milize::RefType("ref")]] milestro::skia::Typeface*& ret);
MILESTRO_API int64_t MilestroSkiaTypefaceGetFamilyNameList(milestro::skia::Typeface* typeFace,
...
MILESTRO_API int64_t MilestroSkiaTypefaceFamilyNameListGetSize(milestro::skia::MilestroTypefaceFamilyNameList* list,
                                                               uint64_t& size);
MILESTRO_API int64_t
MilestroSkiaTypefaceFamilyNameListRefElementAt(milestro::skia::MilestroTypefaceFamilyNameList* list,
                                               milestro::skia::FontFamilyName*& ret,
                                               uint64_t index);
MILESTRO_API int64_t
MilestroSkiaTypefaceFamilyNameListGetElementAt(milestro::skia::MilestroTypefaceFamilyNameList* list,
                                               milestro::skia::FontFamilyName*& ret,
                                               uint64_t index);
MILESTRO_API int64_t
MilestroSkiaTypefaceFamilyNameDestroy([[milize::RefType("ref")]] milestro::skia::FontFamilyName*& ret);
MILESTRO_API int64_t MilestroSkiaTypefaceFamilyNameGetName(milestro::skia::FontFamilyName* ret,
                                                           [[milize::CSharpType("IntPtr")]] uint8_t*& ptr,
                                                           uint64_t& size);
MILESTRO_API int64_t MilestroSkiaTypefaceFamilyNameGetLanguage(milestro::skia::FontFamilyName* ret,
                                                               [[milize::CSharpType("IntPtr")]] uint8_t*& ptr,
                                                               uint64_t& size);

MILESTRO_API int64_t MilestroSkiaFontDestroy([[milize::RefType("ref")]] milestro::skia::Font*& ret);
MILESTRO_API int64_t MilestroSkiaFontGetPath(milestro::skia::Font* font, milestro::skia::Path*& path, uint16_t glyphId);
...
MILESTRO_API int64_t MilestroSkiaTextDrawSnapshotCreate(milestro::skia::SlimTextDrawSnapshot*& ret,
                                                        ...
                                                        int32_t a);
MILESTRO_API int64_t
MilestroSkiaTextDrawSnapshotDestroy([[milize::RefType("ref")]] milestro::skia::SlimTextDrawSnapshot*& ret);
MILESTRO_API int64_t MilestroSkiaReusableTextDrawSnapshotCreate(milestro::skia::SlimTextDrawSnapshot*& ret,
                                                                milestro::skia::Font* font,
                                                                uint64_t capacity,
                                                                int32_t r,
                                                                int32_t g,
                                                                int32_t b,
                                                                int32_t a);
MILESTRO_API int64_t MilestroSkiaReusableTextDrawSnapshotUpdateText(milestro::skia::SlimTextDrawSnapshot* ret,
                                                                    [[milize::CSharpType("byte*")]] const uint8_t* text,
                                                                    uint64_t textSize);
MILESTRO_API int64_t MilestroSkiaReusableTextDrawSnapshotCopyTextFrom(milestro::skia::SlimTextDrawSnapshot* ret,
                                                                      milestro::skia::SlimTextDrawSnapshot* source);
MILESTRO_API int64_t MilestroSkiaReusableTextDrawSnapshotMeasureText(milestro::skia::SlimTextDrawSnapshot* ret,
                                                                     float& boundsLeft,
                                                                     float& boundsTop,
                                                                     float& boundsRight,
                                                                     float& boundsBottom,
                                                                     float& advanceX);
MILESTRO_API int64_t
MilestroSkiaReusableTextDrawSnapshotDestroy([[milize::RefType("ref")]] milestro::skia::SlimTextDrawSnapshot*& ret);
...
MILESTRO_API int64_t MilestroSkiaVertexDataGetVertexCount(milestro::skia::VertexData* d, uint64_t& numVertices);
MILESTRO_API int64_t MilestroSkiaVertexDataGetVertexSize(milestro::skia::VertexData* d, uint64_t& vertexSize);
...
MILESTRO_API int64_t MilestroSkiaTextlayoutParagraphGetHeight(milestro::skia::textlayout::Paragraph* p, float& height);
...
MILESTRO_API int64_t
MilestroSkiaTextlayoutParagraphResolveNoWrapContentWidth(milestro::skia::textlayout::Paragraph* p,
...
MILESTRO_API int64_t MilestroSkiaTextlayoutParagraphPaint(milestro::skia::textlayout::Paragraph* p,
                                                          ...
                                                          float x,
                                                          float y);
MILESTRO_API int64_t MilestroSkiaTextlayoutParagraphSplitGlyph(
...
MILESTRO_API int64_t
MilestroSkiaTextlayoutInputBoxDestroy([[milize::RefType("ref")]] milestro::skia::textlayout::InputBox*& ret);
MILESTRO_API int64_t
MilestroSkiaTextlayoutInputBoxCreateDrawSnapshot(milestro::skia::textlayout::InputBox* inputBox,
...
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxGetFocused(milestro::skia::textlayout::InputBox* inputBox,
                                                              int32_t& focused);
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxSetTextOverflow(milestro::skia::textlayout::InputBox* inputBox,
                                                                   int32_t textOverflow);
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxGetTextOverflow(milestro::skia::textlayout::InputBox* inputBox,
                                                                   int32_t& textOverflow);
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxSetEllipsis(milestro::skia::textlayout::InputBox* inputBox,
                                                               [[milize::CSharpType("void*")]] void* text,
                                                               uint64_t size);
...
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxGetMaskInput(milestro::skia::textlayout::InputBox* inputBox,
                                                                int32_t& maskInput);
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxSetMaskChar(milestro::skia::textlayout::InputBox* inputBox,
                                                               [[milize::CSharpType("void*")]] void* text,
                                                               uint64_t size);
...
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxSetCaretVisible(milestro::skia::textlayout::InputBox* inputBox,
                                                                   int32_t visible);
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxSetAutoMargin(milestro::skia::textlayout::InputBox* inputBox,
                                                                 int32_t left,
                                                                 int32_t top,
                                                                 int32_t right,
                                                                 int32_t bottom);
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxGetAutoMargin(milestro::skia::textlayout::InputBox* inputBox,
                                                                 int32_t& left,
                                                                 int32_t& top,
                                                                 int32_t& right,
                                                                 int32_t& bottom);
...
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxCommitComposition(milestro::skia::textlayout::InputBox* inputBox,
                                                                     ...
                                                                     uint64_t size,
                                                                     int32_t& changed);
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxClearComposition(milestro::skia::textlayout::InputBox* inputBox,
                                                                    int32_t& changed);
...
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxRedo(milestro::skia::textlayout::InputBox* inputBox,
                                                        int32_t& changed);
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxBreakUndoGroup(milestro::skia::textlayout::InputBox* inputBox);
...
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxMoveNext(milestro::skia::textlayout::InputBox* inputBox,
                                                            int32_t& changed);
MILESTRO_API int64_t
MilestroSkiaTextlayoutInputBoxMovePreviousExtendingSelection(milestro::skia::textlayout::InputBox* inputBox,
                                                             int32_t extendSelection,
                                                             int32_t& changed);
MILESTRO_API int64_t
MilestroSkiaTextlayoutInputBoxMoveNextExtendingSelection(milestro::skia::textlayout::InputBox* inputBox,
                                                         int32_t extendSelection,
                                                         int32_t& changed);
MILESTRO_API int64_t
MilestroSkiaTextlayoutInputBoxMoveUpExtendingSelection(milestro::skia::textlayout::InputBox* inputBox,
                                                       int32_t extendSelection,
                                                       int32_t& changed);
MILESTRO_API int64_t
MilestroSkiaTextlayoutInputBoxMoveDownExtendingSelection(milestro::skia::textlayout::InputBox* inputBox,
                                                         int32_t extendSelection,
                                                         int32_t& changed);
MILESTRO_API int64_t
MilestroSkiaTextlayoutInputBoxMoveLineStartExtendingSelection(milestro::skia::textlayout::InputBox* inputBox,
                                                              int32_t extendSelection,
                                                              int32_t& changed);
MILESTRO_API int64_t
MilestroSkiaTextlayoutInputBoxMoveLineEndExtendingSelection(milestro::skia::textlayout::InputBox* inputBox,
                                                            int32_t extendSelection,
                                                            int32_t& changed);
MILESTRO_API int64_t
MilestroSkiaTextlayoutInputBoxMoveDocumentStartExtendingSelection(milestro::skia::textlayout::InputBox* inputBox,
                                                                  int32_t extendSelection,
                                                                  int32_t& changed);
MILESTRO_API int64_t
MilestroSkiaTextlayoutInputBoxMoveDocumentEndExtendingSelection(milestro::skia::textlayout::InputBox* inputBox,
                                                                int32_t extendSelection,
                                                                int32_t& changed);
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxHitTest(milestro::skia::textlayout::InputBox* inputBox,
                                                           ...
                                                           int32_t& changed);
MILESTRO_API int64_t
MilestroSkiaTextlayoutInputBoxHitTestExtendingSelection(milestro::skia::textlayout::InputBox* inputBox,
                                                        float x,
                                                        float y,
                                                        int32_t extendSelection,
                                                        int32_t& changed);
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxEnsureCaretVisible(milestro::skia::textlayout::InputBox* inputBox);
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxScrollByX(milestro::skia::textlayout::InputBox* inputBox,
                                                             float delta,
                                                             int32_t& changed);
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxScrollByY(milestro::skia::textlayout::InputBox* inputBox,
                                                             float delta,
                                                             int32_t& changed);
...
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxGetSelectedText(milestro::skia::textlayout::InputBox* inputBox,
                                                                   milestro::game::model::BytesWrapper*& ret);
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxSetSelectionUtf8(milestro::skia::textlayout::InputBox* inputBox,
                                                                    uint64_t anchorUtf8,
                                                                    uint64_t focusUtf8,
                                                                    int32_t anchorAffinity,
                                                                    int32_t focusAffinity,
                                                                    int32_t& changed);
MILESTRO_API int64_t MilestroSkiaTextlayoutInputBoxClearSelection(milestro::skia::textlayout::InputBox* inputBox,
                                                                  int32_t& changed);
...
MILESTRO_API int64_t
MilestroSkiaTextlayoutParagraphStyleGetStrutStyle(milestro::skia::textlayout::ParagraphStyle* s,
                                                  milestro::skia::textlayout::StrutStyle*& strutStyle);
MILESTRO_API int64_t
MilestroSkiaTextlayoutParagraphStyleSetStrutStyle(milestro::skia::textlayout::ParagraphStyle* s,
                                                  milestro::skia::textlayout::StrutStyle* strutStyle);
MILESTRO_API int64_t
MilestroSkiaTextlayoutParagraphStyleGetTextStyle(milestro::skia::textlayout::ParagraphStyle* s,
                                                 milestro::skia::textlayout::TextStyle*& textStyle);
...
MILESTRO_API int64_t
MilestroSkiaTextlayoutParagraphStyleGetReplaceTabCharacters(milestro::skia::textlayout::ParagraphStyle* s, int32_t& v);
MILESTRO_API int64_t
MilestroSkiaTextlayoutParagraphStyleSetReplaceTabCharacters(milestro::skia::textlayout::ParagraphStyle* s, int32_t v);
MILESTRO_API int64_t
MilestroSkiaTextlayoutParagraphStyleGetApplyRoundingHack(milestro::skia::textlayout::ParagraphStyle* s, int32_t& v);
MILESTRO_API int64_t
MilestroSkiaTextlayoutParagraphStyleSetApplyRoundingHack(milestro::skia::textlayout::ParagraphStyle* s, int32_t v);
...
MILESTRO_API int64_t
MilestroSkiaTextlayoutStrutStyleSetFontFamilies(milestro::skia::textlayout::StrutStyle* s,
                                                [[milize::CSharpType("void**")]] uint8_t** families,
                                                uint32_t size);
MILESTRO_API int64_t
MilestroSkiaTextlayoutStrutStyleSetFontFamilyTokens(milestro::skia::textlayout::StrutStyle* s,
                                                    [[milize::CSharpType("void**")]] uint8_t** families,
                                                    [[milize::CSharpType("int*")]] int32_t* familyKinds,
                                                    uint32_t size);
...
MILESTRO_API int64_t MilestroSkiaTextlayoutStrutStyleGetFontStyle(milestro::skia::textlayout::StrutStyle* s,
                                                                  ...
                                                                  int32_t& width,
                                                                  int32_t& slant);
MILESTRO_API int64_t MilestroSkiaTextlayoutStrutStyleSetFontSize(milestro::skia::textlayout::StrutStyle* s, float size);
MILESTRO_API int64_t MilestroSkiaTextlayoutStrutStyleGetFontSize(milestro::skia::textlayout::StrutStyle* s,
                                                                 float& size);
MILESTRO_API int64_t MilestroSkiaTextlayoutStrutStyleSetHeight(milestro::skia::textlayout::StrutStyle* s, float height);
...
MILESTRO_API int64_t MilestroSkiaTextlayoutTextStyleSetFontSize(milestro::skia::textlayout::TextStyle* s, float size);
MILESTRO_API int64_t MilestroSkiaTextlayoutTextStyleGetFontSize(milestro::skia::textlayout::TextStyle* s, float& size);
MILESTRO_API int64_t MilestroSkiaTextlayoutTextStyleSetFontFamilies(milestro::skia::textlayout::TextStyle* s,
                                                                    [[milize::CSharpType("void**")]] uint8_t** families,
                                                                    uint32_t size);
MILESTRO_API int64_t MilestroSkiaTextlayoutTextStyleSetFontFamilyTokens(milestro::skia::textlayout::TextStyle* s,
                                                                        [[milize::CSharpType("void**")]] uint8_t** families,
                                                                        [[milize::CSharpType("int*")]] int32_t* familyKinds,
                                                                        uint32_t size);
...
MILESTRO_API int64_t MilestroSkiaTextlayoutTextStyleGetBaselineShift(milestro::skia::textlayout::TextStyle* s,
                                                                     float& baselineShift);
MILESTRO_API int64_t MilestroSkiaTextlayoutTextStyleSetHeight(milestro::skia::textlayout::TextStyle* s, float height);
MILESTRO_API int64_t MilestroSkiaTextlayoutTextStyleGetHeight(milestro::skia::textlayout::TextStyle* s, float& height);
...
MILESTRO_API int64_t MilestroCopyAndLoadICU([[milize::CSharpType("byte*")]] uint8_t* ptr,
                                            uint64_t size,
                                            [[milize::CSharpType("byte*")]] uint8_t* dir);
MILESTRO_API int64_t MilestroLoadICU([[milize::CSharpType("byte*")]] uint8_t* ptr,
                                     [[milize::CSharpType("byte*")]] uint8_t* dir);
