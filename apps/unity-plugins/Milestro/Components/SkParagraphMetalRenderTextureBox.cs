...
namespace Milestro.Components
{
    ...
    public class SkParagraphMetalRenderTextureBox : MonoBehaviour
    {
        [TextArea(3, 10)]
        [SerializeField]
        ...
        [NonSerialized] private UnityMetalRenderTextureSurface surface;
        ...
        private void RebuildResources(bool forceText, bool forceImage)
        {
            ...
            if (surface == null || surface.Srgb != surfaceSrgb)
            {
                ...
                surface = new UnityMetalRenderTextureSurface(sizePixels.x, sizePixels.y, surfaceSrgb);
