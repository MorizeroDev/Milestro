...
int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxCreate(
        milestro::skia::textlayout::InputBox*& ret,
...
int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxGetText(
        milestro::skia::textlayout::InputBox* inputBox,
        [[milize::CSharpType("IntPtr")]] uint8_t*& ptr,
        uint64_t& size) {
    return MilestroSkiaTextlayoutInputBoxGetText(inputBox, ptr, size);
}

int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxSetViewport(
        milestro::skia::textlayout::InputBox* inputBox,
        float width,
        float height) {
...
int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxSetCaretColor(
        milestro::skia::textlayout::InputBox* inputBox,
        int32_t r,
        int32_t g,
        int32_t b,
...
int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxSetCaretWidth(
        milestro::skia::textlayout::InputBox* inputBox,
        float width) {
    return MilestroSkiaTextlayoutInputBoxSetCaretWidth(inputBox, width);
}

int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxSetCaretVisible(
        milestro::skia::textlayout::InputBox* inputBox,
        int32_t visible) {
    return MilestroSkiaTextlayoutInputBoxSetCaretVisible(inputBox, visible);
}

int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxInsertText(
        milestro::skia::textlayout::InputBox* inputBox,
        [[milize::CSharpType("void*")]] void* text,
        uint64_t size) {
...
int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxDeleteBackward(
        milestro::skia::textlayout::InputBox* inputBox,
        int32_t& changed) {
    return MilestroSkiaTextlayoutInputBoxDeleteBackward(inputBox, changed);
}

int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxDeleteForward(
        milestro::skia::textlayout::InputBox* inputBox,
        int32_t& changed) {
    return MilestroSkiaTextlayoutInputBoxDeleteForward(inputBox, changed);
}

int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxMovePrevious(
        milestro::skia::textlayout::InputBox* inputBox,
        int32_t& changed) {
    return MilestroSkiaTextlayoutInputBoxMovePrevious(inputBox, changed);
}

int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxMoveNext(
        milestro::skia::textlayout::InputBox* inputBox,
        int32_t& changed) {
    return MilestroSkiaTextlayoutInputBoxMoveNext(inputBox, changed);
}

int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxHitTest(
        milestro::skia::textlayout::InputBox* inputBox,
        float x,
        float y,
        int32_t& changed) {
...
int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxEnsureCaretVisible(
        milestro::skia::textlayout::InputBox* inputBox) {
    return MilestroSkiaTextlayoutInputBoxEnsureCaretVisible(inputBox);
}

int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxGetCursor(
        milestro::skia::textlayout::InputBox* inputBox,
        uint64_t& utf8Offset,
...
int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxSetCursorUtf8(
        milestro::skia::textlayout::InputBox* inputBox,
        uint64_t utf8Offset,
        int32_t affinity) {
...
int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxUtf8ToUtf16(
        milestro::skia::textlayout::InputBox* inputBox,
        uint64_t utf8Offset,
        uint64_t& utf16Offset) {
...
int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxUtf16ToUtf8(
        milestro::skia::textlayout::InputBox* inputBox,
        uint64_t utf16Offset,
        uint64_t& utf8Offset) {
...
int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxSnapUtf8(
        milestro::skia::textlayout::InputBox* inputBox,
        uint64_t utf8Offset,
        int32_t mode,
...
int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxGetCaretRect(
        milestro::skia::textlayout::InputBox* inputBox,
        float& left,
        float& top,
        float& right,
...
int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxGetMetrics(
        milestro::skia::textlayout::InputBox* inputBox,
        float& height,
        float& longestLine,
...
int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxGetLineCount(
        milestro::skia::textlayout::InputBox* inputBox,
        uint64_t& lineCount) {
    return MilestroSkiaTextlayoutInputBoxGetLineCount(inputBox, lineCount);
}

int64_t FrameworkBindingMilestroSkiaTextlayoutInputBoxGetLineMetrics(
        milestro::skia::textlayout::InputBox* inputBox,
        uint64_t lineNumber,
        uint64_t& startUtf8,
        uint64_t& endUtf8,
