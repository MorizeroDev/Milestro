...
internal static extern unsafe long SkiaFontManagerRegisterFontFromFile( byte[] path);
            ...
            internal static extern unsafe long SkiaFontManagerGetFontFamilies( byte[] buffer,
 ulong bufferSize,
out ulong needed);
...
internal static extern unsafe long SkiaTypefaceDestroy(out IntPtr ret);
            ...
            internal static extern unsafe long SkiaTypefaceGetFamilyNames( IntPtr typeFace,
 byte[] buffer,
 ulong bufferSize,
out ulong needed);
            ...
            internal static extern unsafe long SkiaFontGetPath( IntPtr font,
out IntPtr path,
 ushort glyphId);
...
internal static extern unsafe long SkiaPathDestroy(out IntPtr ret);
            ...
            internal static extern unsafe long SkiaPathToAATriangles( IntPtr p,
out IntPtr vertexData,
 float tolerance);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaSvgCreate")]
           internal static extern unsafe long SkiaSvgCreate(out IntPtr ret,
void* data,
ulong size);
...
internal static extern unsafe long SkiaSvgDestroy(out IntPtr ret);
           ...
           internal static extern unsafe long SkiaSvgRender( IntPtr svg,
IntPtr canvas);
...
internal static extern unsafe long SkiaVertexDataDestroy(out IntPtr ret);
            ...
            internal static extern unsafe long SkiaVertexDataGetVertexCount( IntPtr d,
out ulong numVertices);
            

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaVertexDataGetVertexSize")]
            internal static extern unsafe long SkiaVertexDataGetVertexSize( IntPtr d,
out ulong vertexSize);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaVertexDataFillData")]
           internal static extern unsafe long SkiaVertexDataFillData( IntPtr d,
void* dst);
...
internal static extern unsafe long SkiaFontCollectionSetFontFallbackEnabled( int enabled);
           ...
           internal static extern unsafe long SkiaCanvasCreate(out IntPtr ret,
int width,
int height);
...
internal static extern unsafe long SkiaCanvasDestroy(out IntPtr ret);
           ...
           internal static extern unsafe long SkiaCanvasGetTexture( IntPtr ret,
void* targetSpace);
           

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaCanvasDrawImageSimple")]
           internal static extern unsafe long SkiaCanvasDrawImageSimple( IntPtr ret,
IntPtr image,
float x,
float y);
...
float dstBottom);
           ...
           internal static extern unsafe long SkiaImageCreate(out IntPtr ret,
void* data,
ulong size);
           ...
           internal static extern unsafe long SkiaImageSetColorType( IntPtr img,
int targetColorType);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaImageGetWidth")]
            internal static extern unsafe long SkiaImageGetWidth( IntPtr img,
out int width);
            

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaImageGetHeight")]
            internal static extern unsafe long SkiaImageGetHeight( IntPtr img,
out int height);
...
internal static extern unsafe long SkiaTextlayoutParagraphDestroy(out IntPtr ret);
           ...
           internal static extern unsafe long SkiaTextlayoutParagraphLayout( IntPtr p,
float width);
           

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphPaint")]
           internal static extern unsafe long SkiaTextlayoutParagraphPaint( IntPtr p,
IntPtr canvas,
float x,
float y);
           ...
           internal static extern unsafe long SkiaTextlayoutParagraphSplitGlyph( IntPtr p,
IntPtr context,
float x,
float y,
...
void* distanceField);
            ...
            internal static extern unsafe long SkiaTextlayoutParagraphToPath( IntPtr p,
out IntPtr path,
 float x,
 float y);
           ...
           internal static extern unsafe long SkiaTextlayoutParagraphBuilderCreate(out IntPtr ret,
IntPtr style);
...
internal static extern unsafe long SkiaTextlayoutParagraphBuilderDestroy(out IntPtr ret);
           ...
           internal static extern unsafe long SkiaTextlayoutParagraphBuilderPushStyle( IntPtr b,
IntPtr style);
...
internal static extern unsafe long SkiaTextlayoutParagraphBuilderPop( IntPtr b);
            ...
            internal static extern unsafe long SkiaTextlayoutParagraphBuilderBuild( IntPtr b,
out IntPtr paragraph);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphBuilderAddText")]
           internal static extern unsafe long SkiaTextlayoutParagraphBuilderAddText( IntPtr b,
byte[] text,
ulong len);
...
internal static extern unsafe long SkiaTextlayoutParagraphStyleDestroy(out IntPtr ret);
            ...
            internal static extern unsafe long SkiaTextlayoutParagraphStyleGetStrutStyle( IntPtr s,
out IntPtr strutStyle);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleSetStrutStyle")]
           internal static extern unsafe long SkiaTextlayoutParagraphStyleSetStrutStyle( IntPtr s,
IntPtr strutStyle);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleGetTextStyle")]
            internal static extern unsafe long SkiaTextlayoutParagraphStyleGetTextStyle( IntPtr s,
out IntPtr textStyle);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleSetTextStyle")]
           internal static extern unsafe long SkiaTextlayoutParagraphStyleSetTextStyle( IntPtr s,
IntPtr textStyle);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleGetTextDirection")]
            internal static extern unsafe long SkiaTextlayoutParagraphStyleGetTextDirection( IntPtr s,
out int direction);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleSetTextDirection")]
           internal static extern unsafe long SkiaTextlayoutParagraphStyleSetTextDirection( IntPtr s,
int direction);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleGetTextAlign")]
            internal static extern unsafe long SkiaTextlayoutParagraphStyleGetTextAlign( IntPtr s,
out int align);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleSetTextAlign")]
           internal static extern unsafe long SkiaTextlayoutParagraphStyleSetTextAlign( IntPtr s,
int align);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleGetMaxLines")]
            internal static extern unsafe long SkiaTextlayoutParagraphStyleGetMaxLines( IntPtr s,
out ulong maxLines);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleSetMaxLines")]
           internal static extern unsafe long SkiaTextlayoutParagraphStyleSetMaxLines( IntPtr s,
ulong maxLines);
           

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleSetEllipsis")]
           internal static extern unsafe long SkiaTextlayoutParagraphStyleSetEllipsis( IntPtr s,
byte[] ellipsis);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleGetHeight")]
            internal static extern unsafe long SkiaTextlayoutParagraphStyleGetHeight( IntPtr s,
out float height);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleSetHeight")]
           internal static extern unsafe long SkiaTextlayoutParagraphStyleSetHeight( IntPtr s,
float height);
...
out int behavior);
           ...
           internal static extern unsafe long SkiaTextlayoutParagraphStyleSetTextHeightBehavior( IntPtr s,
int behavior);
...
out int unlimitedLines);
            ...
            internal static extern unsafe long SkiaTextlayoutParagraphStyleIsEllipsized( IntPtr s,
out int isEllipsized);
...
out int effectiveAlign);
            ...
            internal static extern unsafe long SkiaTextlayoutParagraphStyleIsHintingOn( IntPtr s,
out int hintingIsOn);
...
internal static extern unsafe long SkiaTextlayoutParagraphStyleTurnHintingOff( IntPtr s);
            ...
            internal static extern unsafe long SkiaTextlayoutParagraphStyleGetReplaceTabCharacters( IntPtr s,
out int v);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleSetReplaceTabCharacters")]
           internal static extern unsafe long SkiaTextlayoutParagraphStyleSetReplaceTabCharacters( IntPtr s,
int v);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleGetApplyRoundingHack")]
            internal static extern unsafe long SkiaTextlayoutParagraphStyleGetApplyRoundingHack( IntPtr s,
out int v);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutParagraphStyleSetApplyRoundingHack")]
           internal static extern unsafe long SkiaTextlayoutParagraphStyleSetApplyRoundingHack( IntPtr s,
int v);
...
internal static extern unsafe long SkiaTextlayoutStrutStyleDestroy(out IntPtr ret);
           ...
           internal static extern unsafe long SkiaTextlayoutStrutStyleSetFontFamilies( IntPtr s,
void** families,
uint size);
           ...
           internal static extern unsafe long SkiaTextlayoutStrutStyleSetFontStyle( IntPtr s,
int weight,
int width,
int slant);
            ...
            internal static extern unsafe long SkiaTextlayoutStrutStyleGetFontStyle( IntPtr s,
out int weight,
out int width,
out int slant);
...
internal static extern unsafe long SkiaTextlayoutTextStyleDestroy(out IntPtr ret);
           ...
           internal static extern unsafe long SkiaTextlayoutTextStyleSetColor( IntPtr s,
int r,
int g,
int b,
int a);
            ...
            internal static extern unsafe long SkiaTextlayoutTextStyleGetColor( IntPtr s,
out int r,
out int g,
out int b,
out int a);
            ...
            internal static extern unsafe long SkiaTextlayoutTextStyleGetDecoration( IntPtr s,
out int decoration);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleSetDecoration")]
           internal static extern unsafe long SkiaTextlayoutTextStyleSetDecoration( IntPtr s,
int decoration);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleGetDecorationMode")]
            internal static extern unsafe long SkiaTextlayoutTextStyleGetDecorationMode( IntPtr s,
out int decoration);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleSetDecorationMode")]
           internal static extern unsafe long SkiaTextlayoutTextStyleSetDecorationMode( IntPtr s,
int decorationMode);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleGetDecorationColor")]
            internal static extern unsafe long SkiaTextlayoutTextStyleGetDecorationColor( IntPtr s,
out int r,
out int g,
out int b,
out int a);
           ...
           internal static extern unsafe long SkiaTextlayoutTextStyleSetDecorationColor( IntPtr s,
int r,
int g,
int b,
int a);
            ...
            internal static extern unsafe long SkiaTextlayoutTextStyleGetDecorationStyle( IntPtr s,
out int decorationStyle);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleSetDecorationStyle")]
           internal static extern unsafe long SkiaTextlayoutTextStyleSetDecorationStyle( IntPtr s,
int decorationStyle);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleGetDecorationThicknessMultiplier")]
            internal static extern unsafe long SkiaTextlayoutTextStyleGetDecorationThicknessMultiplier( IntPtr s,
out float multiplier);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleSetDecorationThicknessMultiplier")]
...
float multiplier);
           ...
           internal static extern unsafe long SkiaTextlayoutTextStyleSetFontStyle( IntPtr s,
int weight,
int width,
int slant);
            ...
            internal static extern unsafe long SkiaTextlayoutTextStyleGetFontStyle( IntPtr s,
out int weight,
out int width,
out int slant);
...
internal static extern unsafe long SkiaTextlayoutTextStyleResetShadow( IntPtr s);
            ...
            internal static extern unsafe long SkiaTextlayoutTextStyleGetFontFeatureNumber( IntPtr s,
out ulong num);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleAddFontFeature")]
           internal static extern unsafe long SkiaTextlayoutTextStyleAddFontFeature( IntPtr s,
byte[] fontFeature,
int value);
...
internal static extern unsafe long SkiaTextlayoutTextStyleResetFontFeatures( IntPtr s);
           ...
           internal static extern unsafe long SkiaTextlayoutTextStyleSetFontSize( IntPtr s,
float size);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleGetFontSize")]
            internal static extern unsafe long SkiaTextlayoutTextStyleGetFontSize( IntPtr s,
out float size);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleSetFontFamilies")]
           internal static extern unsafe long SkiaTextlayoutTextStyleSetFontFamilies( IntPtr s,
void** families,
uint size);
           ...
           internal static extern unsafe long SkiaTextlayoutTextStyleSetBaselineShift( IntPtr s,
float baselineShift);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleGetBaselineShift")]
            internal static extern unsafe long SkiaTextlayoutTextStyleGetBaselineShift( IntPtr s,
out float baselineShift);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleSetHeight")]
           internal static extern unsafe long SkiaTextlayoutTextStyleSetHeight( IntPtr s,
float height);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleGetHeight")]
            internal static extern unsafe long SkiaTextlayoutTextStyleGetHeight( IntPtr s,
out float height);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleSetHeightOverride")]
           internal static extern unsafe long SkiaTextlayoutTextStyleSetHeightOverride( IntPtr s,
int v);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleGetHeightOverride")]
            internal static extern unsafe long SkiaTextlayoutTextStyleGetHeightOverride( IntPtr s,
out int v);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleSetHalfLeading")]
           internal static extern unsafe long SkiaTextlayoutTextStyleSetHalfLeading( IntPtr s,
int halfLeading);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleGetHalfLeading")]
            internal static extern unsafe long SkiaTextlayoutTextStyleGetHalfLeading( IntPtr s,
out int halfLeading);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleSetLetterSpacing")]
           internal static extern unsafe long SkiaTextlayoutTextStyleSetLetterSpacing( IntPtr s,
float letterSpacing);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleGetLetterSpacing")]
            internal static extern unsafe long SkiaTextlayoutTextStyleGetLetterSpacing( IntPtr s,
out float letterSpacing);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleSetWordSpacing")]
           internal static extern unsafe long SkiaTextlayoutTextStyleSetWordSpacing( IntPtr s,
float wordSpacing);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleGetWordSpacing")]
            internal static extern unsafe long SkiaTextlayoutTextStyleGetWordSpacing( IntPtr s,
out float wordSpacing);
            

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleSetTypeface")]
           internal static extern unsafe long SkiaTextlayoutTextStyleSetTypeface( IntPtr s,
IntPtr typeFace);
           

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleSetLocale")]
           internal static extern unsafe long SkiaTextlayoutTextStyleSetLocale( IntPtr s,
byte[] locale);
           

           
           [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleSetTextBaseline")]
           internal static extern unsafe long SkiaTextlayoutTextStyleSetTextBaseline( IntPtr s,
int textBaseline);
           

            
            [DllImport(dllName, EntryPoint = EntryPointPrefix + "MilestroSkiaTextlayoutTextStyleGetTextBaseline")]
            internal static extern unsafe long SkiaTextlayoutTextStyleGetTextBaseline( IntPtr s,
out int textBaseline);
...
internal static extern unsafe long SkiaTextlayoutTextStyleSetPlaceholder( IntPtr s);
            ...
            internal static extern unsafe long SkiaTextlayoutTextStyleIsPlaceholder( IntPtr s,
out int isPlaceholder);
